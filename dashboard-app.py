...
#Insert warning
col1.st.warning("*Disclaimer: The years 2020 and 2021 are excluded due to the COVID-19 pandemic!*")
...
period = col2.st.selectbox(label = 'Select study:', 
...
if period == 'Study 1':	
	x = col2.st.radio(label = "Select type of passengers:", 
	...
	y = col2.st.multiselect(label = "Select weather factor(s):", 
